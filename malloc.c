...
pthread_mutex_t __malloc_mutex __attribute__((visibility("hidden"))) = PTHREAD_MUTEX_INITIALIZER;

#define _MALLOC_LOCK() pthread_mutex_lock(&__malloc_mutex)
#define _MALLOC_UNLOCK() pthread_mutex_unlock(&__malloc_mutex)
